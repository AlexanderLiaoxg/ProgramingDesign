       ...
       -->
		...
		<div class="main-up">
			<div class="jumbotron" style="margin-top: 100px;height: 600px;">
				<h1 style="text-align: center; padding:45px;padding-top: 90px;">利用积分转换下载卷，生活更精彩    ！</h1>
				<form action="ConversionServlet" method="post">
					<table class="up_list">
						<tr >
							<td style="width: 419.11px;"><label>充值下载卷额： </label>
								<br/><br/>
							</td>
						</tr>

						<tr>
							<td style="padding-left:120px;padding-bottom: 16px;">
								<!-- onkeydown -> onkeypress -> onkeyup-->
								兑换<input style="width: 56px;text-align: center;" type="text" name="down_value" id="down_value" value="3" onkeyup="value=value.replace(/[^\d]/g,''); to_down(this.value)"/>
								个下载卷
							</td>
						</tr>
						<tr>
							<td style="text-align: center;">
								您需要耗费的积分：
								<font id="jifen" size="48" color="orangered">30</font>
								<font size="4" color="orangered">积分</font>
							</td>
						</tr>
						<tr>
						</tr>
						...
						<tr>
							<td style="padding-left: 100px;">
								<button type="submit" class="up chongzhi" style="vertical-align:middle;height: 60px;"><span>兑换 </span></button>
							</td>
						</tr>
					</table>
