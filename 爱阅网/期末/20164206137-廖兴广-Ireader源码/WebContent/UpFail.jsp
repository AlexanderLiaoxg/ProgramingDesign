       ...
       -->
		...
		<div class="main-up">
			<div class="jumbotron" style="margin-top: 100px;height: 600px;">
				<h1 style="text-align: center; padding:45px;padding-top: 90px;">很遗憾，上传失败了！</h1>
				<form action="UpPage.jsp" method="post">
					...
					<table class="up_list">
						<tbody>
							<tr>
								<td>
								<p style="font-size: 38px;margin: auto;text-align: center;">File erroe!</p>
								</td>
							</tr>
							<tr></tr>
							<tr>
								<td><p style="font-size: 38px;margin: auto;text-align: center;">Error: 表单必须包含 enctype=multipart/form-data</p></td>
							</tr>
							<tr></tr>
