       ...
       -->
		...
		<div class="main-up">
			<div class="jumbotron" style="margin-top: 100px;height: 600px;">
				<h1 style="text-align: center; padding:45px;padding-top: 90px;">恭喜您！注册成功！</h1>
				<form action="ToDownPageServlet" method="post">

					<table class="up_list">
						<tbody>
							<tr>
								<td>
								<p style="font-size: 38px;margin: auto;text-align: center;">尊敬的<label>${name }</label>,您的账户是<font color="red">${account }</p>
								</td>
							</tr>
							<tr></tr>
							<tr>
								<td><p style="font-size: 38px;margin: auto;text-align: center;">温馨提示： 上传越多资源，可以获得越多积分哦！</p></td>
							</tr>
							<tr></tr>
