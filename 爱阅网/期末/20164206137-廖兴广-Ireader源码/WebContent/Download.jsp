...
// 				alert("分为俩部分，点击任一文章进入阅读");
			</script>
			<div id="main-left">
				<div class="row" id="row1">
				<div class="read">
					<a href="code.jsp"><img src="img/Download/五鬼抬轿.jpg" /></a>
					<h4 style="text-align: center;">五鬼抬轿</h4>
				</div>
				<div class="read">
					<a href="code.jsp"><img src="img/Download/风中的妈妈.jpg" /></a>
					<h4 style="text-align: center;">风中的妈妈</h4>
				</div>
				</div>
								
								
				<div class="row" id="row2">				
				<div class="read" id="forPosition1">
					<div class="divMask" style=""></div>
					<a href="code.jsp"><img src="img/Download/千纸鹤谜案.jpg" /></a>
					<h4 style="text-align: center;">千纸鹤谜案</h4>
				</div>
				<div class="read" id="forPosition2">
					<div class="divMask" style=""></div>
					<a href="code.jsp"><img src="img/Download/girl - 副本.jpg" /></a>
					<h4 style="text-align: center;">HTML、CSS基础知识笔记</h4>
				</div>
				</div>
				...
				<div class="read">
					<a href="code.jsp"><img src="img/Download/e...jpg" /></a>
					<h4 style="text-align: center;">CSS层叠样式表代码</h4>
				</div>
				<div class="read">
					<a href="code.jsp"><img src="img/Download/e...jpg" /></a>
					<h4 style="text-align: center;">CSS层叠样式表代码</h4>
			...
			$(document).ready(
				function() {
					...
					$('.read').hover(
						function(){
							$(this).find('.divMask').stop().animate({top:'0px'},500)
						}
					)
					...
					$('.read').mouseleave(
						function(){
							$(this).find('.divMask').stop().animate({top:'-500px'},500);
