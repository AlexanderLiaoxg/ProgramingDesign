       ...
       -->
		...
		<div class="main-up">
			<div class="jumbotron" style="margin-top: 100px;height: 600px;">
				<h1 style="text-align: center; padding:45px;padding-top: 90px;">爱阅，悦享生活</h1>
				<form action="Voucher_Center.jsp" method="post">

					<table class="up_list">
						<tbody>
							<tr>
								<td>
								<p style="font-size: 38px;margin: auto;text-align: center;">恭喜您！充值成功！</p>
								</td>
							</tr>
							<tr></tr>
							<tr>
