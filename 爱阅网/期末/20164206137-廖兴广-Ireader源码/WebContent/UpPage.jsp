...
<html>
   ...
   <div class="jumbotron" style="margin-top: 100px;height: 600px;">
        ...
        <form action="UploadServlet" method="post" enctype="multipart/form-data">
        	<table class="up_list">
       	<tr>
       		<td><label>选择上传文件： </label>
    <br/><br/>
       		</td>
       	</tr>
       	<tr>
       		<td style="text-align: center;">
       		请输入文件名称：<input type="text" name="file_name" id="file_name">
       		</td>
       		<td style="text-align: left;">类别：<select id="type" name="type">
...
<!--        	</tr> -->
       	...
       	<tr>
       		<td style="padding-left: 180px;">
       			 <button type="submit" class="up" style="vertical-align:middle;height: 60px;"><span>上传 </span></button>
       		</td>
       	</tr>
       </table>
        </form>
